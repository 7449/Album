...
import com.gallery.ui.wechat.databinding.GalleryWechatItemPrevSelectBinding
...
class WeChatPrevSelectAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            GalleryWechatItemPrevSelectBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        frameLayout.setBackgroundResource(if (entity.isSelected) R.drawable.gallery_wechat_selector_gallery_select else 0)
    ...
    class ViewHolder(val binding: GalleryWechatItemPrevSelectBinding) :
