...
class MainActivity : GalleryListActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.startConfig.setOnClickListener {
            ...
            val newBundle = galleryBundle.copy(type = scanArray)
            Gallery.newInstance(
                activity = this,
                ...
                bundle = newBundle.copy(
                    ...
                    cameraConfig = CameraConfig(
                        if (newBundle.isScanVideoMedia) "摄像" else "拍照",
                        16F,
                        Color.WHITE
                    ),
                    ...
                    cameraName = System.currentTimeMillis()
                        .toString() to if (newBundle.isScanVideoMedia) "mp4" else "jpg",
                ),
                gap = galleryArgsBundle.copy(
                    toolbarText = if (newBundle.isScanVideoMedia) "视频选择" else "图片选择"
                ),
