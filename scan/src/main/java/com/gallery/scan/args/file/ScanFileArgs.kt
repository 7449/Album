...
@Parcelize
class ScanFileArgs(
        private val scanTypeArray: Array<String> = arrayOf(MediaStore.Files.FileColumns.MEDIA_TYPE_IMAGE.toString()),
    ...
    override fun createSelectionArgs(args: Bundle): Array<String>? {
