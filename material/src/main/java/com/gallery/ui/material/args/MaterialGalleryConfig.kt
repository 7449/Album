...
data class MaterialGalleryConfig(
    ...
    /*** 文件目录图标*/
    @DrawableRes
    val finderIcon: Int = R.drawable.ic_material_gallery_finder,
    /*** 文件目录图标颜色*/
    @ColorInt
    val finderIconColor: Int = Color.WHITE,
    /*** 预览文字*/
    ...
    /*** 目录View字体颜色*/
    @ColorInt
    val finderItemTextColor: Int = Color.BLACK,
    /*** 目录View字体个数颜色*/
    @ColorInt
    val finderItemTextCountColor: Int = Color.BLACK,
    /*** 预览页title*/
